...
export function MobileAuditClient({ categories, uoms = [] }: { categories: any[], uoms?: any[] }) {
    ...
    const [batches, setBatches] = useState<BatchEntry[]>([
        { id: '1', batchNo: '', expiryDate: '', mrp: '', cost: '', salePrice: '', qty: '', uom: 'PCS', conversionFactor: 1 }
    ]);
    ...
    const selectProduct = (product: any) => {
        ...
        setBatches([{
            ...
            batchNo: batchNo,
            expiryDate: expiry,
            mrp: defaultMrp.toString(),
            cost: defaultCost.toString(),
            salePrice: defaultSale.toString(),
    ...
    const handleSync = async () => {
        ...
        const validBatches = batches.filter(b => b.batchNo && b.qty);
        if (validBatches.length === 0) {
            toast.error("Please enter at least one batch with quantity");
            return;
        }
        ...
        try {
            ...
            if ('success' in result) {
                ...
                setSearchQuery('');
                setSuggestions([]);
                setBatches([{ id: '1', batchNo: '', expiryDate: '', mrp: '', cost: '', salePrice: '', qty: '', uom: 'PCS', conversionFactor: 1 }]);
                setIsNewProduct(false);
            } else {
                                    ...
                                    >
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            ...
                                            <div className="col-span-2 space-y-1">
                                                <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest">Total Qty (Available)</p>
                                                <Input
                                                    type="number"
                                                    value={batch.qty}
